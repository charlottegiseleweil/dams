...
parser.add_argument('--images', type=str, default='../../data/detection-results/images/', help='directory of images output from detect.py')
parser.add_argument('--predicted_bboxes', type=str, default='../../data/detection-results/pred/', help='directory of .txt files of predicted bounding boxes')
parser.add_argument('--ground_truth_bboxes', type=str, default='../../data/detection-results/truth/')
...
def calc_precision_and_recall (df):
	...
	false_pos = len(pred_df[pred_df['iou'] < iou_thres])
